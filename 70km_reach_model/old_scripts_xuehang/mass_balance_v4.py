...
ax1.bar(start_year + np.arange(n_segment), -sum_mass, color="purple")
ax1.set_ylim([0, 8e8])
...
mass_bar_file = open(output_dir + "mass_net_gain.txt", 'w')
for i_mass in sum_mass:
    mass_bar_file.write("%3.2e\n" % -i_mass)
mass_bar_file.close()
