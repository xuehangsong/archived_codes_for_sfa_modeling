...
simu.dir="/Users/song884/remote/reach/Outputs/HFR_200x200x5_1w_bc/"
datum.dir = paste(simu.dir,"bc_1w_smooth_032807/",sep="")

fig.dir = "/Users/song884/remote/reach/figures/HFR_200x200x5_1w_bc/"
...
mass.section = gsub(".txt","",gsub("DatumH_Mass1_","",
                                   list.files(datum.dir,"Datum")))
...
{
    print(i.section)
    datum.data[[i.section]] = read.table(paste(datum.dir,"DatumH_Mass1_",
                                               i.section,".txt",
                                               sep=""))
    gradients.data[[i.section]] = read.table(paste(datum.dir,"Gradients_Mass1_",
                                                   i.section,".txt",
                                                   sep=""))
}
