...
###drift_sets = c(0,1)
## revised by Xuehang 03/16/2018 for generating inland boundaries for Campaign B

rm(list=ls())
library(geoR)
library(rhdf5)

source("400m_parameters.R")
H5close()
options(geoR.messages=FALSE)


input_folder = '/Users/song884/common_data/headdata4krige_Plume_2009_2017/'
output_folder = "/Users/song884/repos/sbr-river-corridor-sfa/400m_model/"
initial.h5 = "results/H_Initial_ERT_2014.h5"
BC.h5 = "results/H_BC_ERT_2014_2017.h5"
...
## time information
start.time = as.POSIXct("2014-01-01 00:00:00",tz="GMT",format="%Y-%m-%d %H:%M:%S")
