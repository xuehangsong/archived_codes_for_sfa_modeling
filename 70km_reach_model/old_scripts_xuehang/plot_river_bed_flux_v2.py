...
fig_dir = "/Users/song884/remote/reach/figures/flux_test/"

pt_fname = ("/Users/song884/remote/reach/results/" +
            "river_flux_2007_new_material_test.pk")
...
for itime in times:
    ...
    ax1.plot([20, 20], [43, 53], "r")
    ax1.plot([41, 51], [48, 48], "g")
    ax1.plot([52, 62], [16, 16], "b")
