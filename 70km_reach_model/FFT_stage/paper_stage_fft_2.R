...
pdf(file=paste(fig.dir,"temp_stage.pdf",sep=""),
     width=10,height=9)
par(mar=c(3,3.5,2.7,0.8),mfrow=c(3,2))
...
mtext(" (d) Spectral density of hourly river stage",3,line=1.1,cex=1.2)
mtext("Frequency (1/hour)",1,line=1.5)
mtext("Spectral density",2,line=1.7)
axis(1,seq(0,0.5,0.02),tck=-0.02,mgp=c(1.5,0.5,0))
axis(2,tck=-0.02,mgp=c(1.5,0.5,0),las=2)
...
legend("topright",c("1 hour"),lty=ltys,lwd=2,
       col=colors,bty="n",horiz=TRUE,
              pt.cex=1,cex=1.2
       )
...
mtext(" (e) Spectral density of daily smoothed river stage",3,line=1.1,cex=1.2)
mtext("Frequency (1/hour)",1,line=1.5)
mtext("Spectral density",2,line=1.7)
axis(1,seq(0,0.5,0.02),tck=-0.02,mgp=c(1.5,0.5,0))
axis(2,tck=-0.02,mgp=c(1.5,0.5,0),las=2)
...
axis(3,
     ...
     col.ticks="black",
     col.axis="black",tck=-0.02,mgp=c(1.5,0.15,0))
legend("topright",c("1 day"),lty=ltys[2],lwd=2,
       col=colors[2],bty="n",horiz=TRUE,
              pt.cex=1,cex=1.2
       )
...
mtext(" (f) Spectral density of weekly smoothed river stage",3,line=1.1,cex=1.2)
mtext("Frequency (1/hour)",1,line=1.5)
mtext("Spectral density",2,line=1.7)
axis(1,seq(0,0.5,0.02),tck=-0.02,mgp=c(1.5,0.5,0))
axis(2,tck=-0.02,mgp=c(1.5,0.5,0),las=2)
...
axis(3,
     ...
     col.ticks="black",
     col.axis="black",tck=-0.02,mgp=c(1.5,0.15,0))
legend("topright",c("1 week"),lty=ltys[3],lwd=2,
       col=colors[3],bty="n",horiz=TRUE,
       pt.cex=1,cex=1.2
       )
