...
fname_material.h5 = "HFR_material_riverID_200x200x2.h5"
# fname_H.BC.h5 = c("300A_H_BC.h5")
fname_H.initial.h5 = "HFR_H_Initial.h5"
fname_model_inputs.r = "results/model_inputs_200x200x2.r"
#-----------------OUTPUT--------------------------#
fname_pflotran.in = "Inputs/riverID/pflotran_riverID_200x200x2.in"
...
fname.river_datum = paste("DatumH_Mass1_", slice.list, ".txt", sep = "")
fname.river_gradient = paste("Gradients_Mass1_", slice.list, ".txt", sep = "")
