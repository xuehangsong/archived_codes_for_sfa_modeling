...
fname_H.initial.h5 = c("HFR_H_Initial_2007_01_01.h5")
fname_model_inputs.r = "results/model_inputs_200m.r"
fname_bc_dir = "bc_1w_smooth_010107/"

fname.DatumH = c("DatumH_Mass1_")
fname.Gradient = c("Gradients_Mass1_")
#-----------------OUTPUT--------------------------#
fname_pflotran.in = "Inputs/HFR_model_200m/pflotran_200m.in"
...
h5.files = 52 # number of hdf5 files to write, 52 w in a year
obs.ts = 6 # hour
