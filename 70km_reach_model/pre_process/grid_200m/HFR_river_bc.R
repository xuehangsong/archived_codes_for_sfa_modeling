...
is.smooth = T
##--------------OUTPUT----------------##
fname_DatumH = "Inputs/HFR_model_100m/bc_smooth/DatumH_Mass1_"
fname_Gradients = "Inputs/HFR_model_100m/bc_smooth/Gradients_Mass1_"
...
# for (islice in 1:nslice) {
#   jpeg(paste("figures/mass_original_vs_mvAve_", slice.list[islice], ".jpg", sep=''),width=8,height=5,units='in', res = 300)
#   
#   plot(ori_time, mass.level[islice, 1:length(ori_time)] ,type = "l", col= "black")
