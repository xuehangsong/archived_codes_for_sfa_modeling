...
#-----------------OUTPUT--------------------------#
fname_pflotran.in = "Inputs/HFR_model_200x200x2_head_bc/pflotran_200x200x2_head_bc.in"
...
Kb = 1 # from Franklin
basalt = list(ID = 9, porosity = 0.43, tortuosity = 1, perm.x = Kb/(9.5e11), perm.y = Kb/(9.5e11), perm.z = Kb/(9.5e12), cc = "cc2")
...
cat("\n")
cat("  PERIODIC TIME 5 day between 32400 h and 76800 h")
cat("\n")
