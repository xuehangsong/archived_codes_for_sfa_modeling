...
fname_geoFramework.r = "results/geoframework_100x100x5.r"
...
##-------------------output---------------------##
fname_fig.surface3d="figures/surface_cell_3d_100m.jpg"
fname_fig.surface2d="figures/surface_cell_2d_100m.jpg"
fname_material_h5 = "Inputs/riverID/HFR_material_riverID_100x100x5.h5"
fname_material_r="results/HFR_material_riverID_100x100x5.r"
fname_fig.grids = "figures/grids_100m.jpg"
fname_river_cell_coord = "results/river_cell_coord_100m.csv"
...
# face.cell.ids.final.unique = unique(face.cell.ids.final)
material.ids[river_cell_coord[, "cell_id"]] = 10
