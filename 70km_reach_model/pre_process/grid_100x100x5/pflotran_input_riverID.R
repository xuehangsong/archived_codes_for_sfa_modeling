...
fname_material.h5 = "HFR_material_riverID_100x100x5.h5"
# fname_H.BC.h5 = c("300A_H_BC.h5")
fname_H.initial.h5 = "HFR_H_Initial.h5"
fname_model_inputs.r = "results/model_inputs_100x100x5.r"
#-----------------OUTPUT--------------------------#
fname_pflotran.in = "Inputs/riverID/pflotran_riverID_100x100x5.in"
...
# xlen = grid.n_pts[1]*grid.d_pts[1]#x boundary length
# ylen = grid.n_pts[2]*grid.d_pts[2] #y boundary length
# zlen = grid.n_pts[3]*grid.d_pts[3] #z boundary length
...
a = 0 #rotation
wall.stop = 39.5 # wallclock stop time, h
...
material.list = c("hanford", "cold_creek", "taylor_flats", "ringold_e", "ringold_lm", "ringold_a", "river_cell", "basalt")
# material properties
# K = 7000 m/d
hanford = list(ID = 1, porosity = 0.2, tortuosity = 1, perm.x = 7.387e-9, perm.y = 7.387e-9, perm.z = 7.387e-10, cc = "cc1")
basalt = list(ID = 9, porosity = 0.2, tortuosity = 1, perm.x = 7.387e-9, perm.y = 7.387e-9, perm.z = 7.387e-10, cc = "cc1")
river_cell = list(ID = 10, porosity = 0.2, tortuosity = 1, perm.x = 7.387e-9, perm.y = 7.387e-9, perm.z = 7.387e-10, cc = "cc1")
# # K = 3500 m/d
# hanford = list(ID = 1, porosity = 0.2, tortuosity = 1, perm.x = 3.69e-9, perm.y = 3.69e-9, perm.z = 3.69e-10)

# # K=40 m/d (from Williams, 2008 report)
# ringold_gravel = list(ID =4, porosity = 0.25, tortuosity = 1, perm.x = 4.724e-11, perm.y = 4.724e-11, perm.z = 4.724e-12)
# # K=1 m/d (from Williams, 2008 report)
# ringold_fine = list(ID =9, porosity = 0.43, tortuosity = 1, perm.x = 1.181e-12, perm.y = 1.181e-12, perm.z = 1.181e-13)
Kcc = 190.5 #m/d
cold_creek = list(ID = 2, porosity = 0.43, tortuosity = 1, perm.x = Kcc/(9.5e11), perm.y = Kcc/(9.5e11), perm.z = Kcc/(9.5e12), cc = "cc2")
Ktf = 10 # m/d
taylor_flats = list(ID = 3, porosity = 0.3, tortuosity = 1, perm.x = Ktf/(9.5e11), perm.y = Ktf/(9.5e11), perm.z = Ktf/(9.5e12), cc = "cc2")
Kre = 3817 # m/d
ringold_e = list(ID = 4, porosity = 0.25, tortuosity = 1, perm.x = Kre/(9.5e11), perm.y = Kre/(9.5e11), perm.z = Kre/(9.5e12), cc = "cc2")
Krlm = 0.00005 #m/d
...
K.list = list(hanford = hanford, cold_creek = cold_creek, taylor_flats = taylor_flats, ringold_e = ringold_e, ringold_lm = ringold_lm, ringold_a = ringold_a, river_cell = river_cell, basalt= basalt)
...
# solute.river.list = paste("Solute_river_", slice.list, sep = "")
# solute.list = c("Solute_river_upstream", "Solute_river_north", "Solute_river_middle",
#                 "Solute_river_south", "Solute_northBC")
solute.list = c("Solute_river")

## condition coupler, each flow region corresponds to one solute
# solute.coupler.list = c(rep(solute.list[1], 5), rep(solute.list[2], 3), rep(solute.list[3], 4), rep(solute.list[4], 12))
...
# concentration.river.list = paste("Concentration_river_", slice.list, sep = "")
# concentration.list = c("Concentration_river_upstream", "Concentration_river_north", "Concentration_river_middle",
#                        "Concentration_river_south", "Concentration_northBC")
...
# tracer.list = c("Tracer_river_upstream", "Tracer_river_north", "Tracer_river_middle", 
#                 "Tracer_river_south", "Tracer_northBC")
tracer.list = c("Tracer_river")
names(tracer.list) = concentration.list

## conductance assign same num. as of flow region
# cond.list = c(rep(upstr_river_cond, 5), rep(north_river_cond, 3), rep(middle_river_cond, 4), rep(south_river_cond, 12))
cond.list = c(rep(river_cond, length(flow_region)))

names(cond.list) = flow_region

# river_datum.list = c("315", "316", "317", "318", "319", "319","319","320", "320", 
#                      "321", "321", "322", "322", "323", "323", "324", "324", "325", "325", "325", "326", "327", 
#                      "328", "329")
# river_gradient.list = c("315", "316", "317", "318", "319", "319","319","320", "320", 
#                         "321", "321", "322", "322", "323", "323", "324", "324", "325", "325", "325", "326", "327", 
#                         "328", "329")

## create river flow bc list
fname.river_datum = paste("DatumH_Mass1_2007_2017_", slice.list, ".txt", sep = "")
fname.river_gradient = paste("Gradients_Mass1_2007_2017_", slice.list, ".txt", sep = "")
...
#   cat("  CYCLIC")
#   cat("\n")
#   cat(paste("  DATUM file bc/", fname.river_datum[iflow], sep = ""))
#   cat("\n")
#   cat("  PRESSURE 101325")
#   cat("\n")
#   cat("  GRADIENT")
#   cat("\n")
#   cat(paste("  PRESSURE file bc/", fname.river_gradient[iflow], sep = ""))
#   cat("\n")
#   cat('  /')
#   cat("\n")
#   cat('/')
