...
<<<<<<< HEAD:pre_process/HFR_200x200x05/PFLOTRAN_input.r
imodel=c("200x200x05")
...
=======
>>>>>>> parent of 44dce6b... updates:pre_process/grid_100x100x2/pflotran_input.R
...
fname_H.initial.h5 = c("Hanford_Reach_2007_Initial.h5")
fname_model_inputs.r = "results/model_inputs.r"
fname_bc_dir = "bc_smooth/"

fname.DatumH = c("DatumH_Mass1_")
fname.Gradient = c("Gradients_Mass1_")
#-----------------OUTPUT--------------------------#
fname_pflotran.in = "Inputs/test_2007/pflotran_2007_new_material.in"
...
fname_pflotran.in = paste(model_dir, "Inputs/HFR_model_", imodel, "/pflotran_", imodel, ".in", sep = "")
