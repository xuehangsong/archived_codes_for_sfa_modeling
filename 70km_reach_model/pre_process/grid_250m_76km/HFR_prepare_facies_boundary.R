...
##---------------------OUTPUT---------------------------##
# fname_fig.hanford.model = "figures/hanford.model.jpg"
# fname_fig.hanford = "figures/hanford.jpg"
# fname_fig.basalt.model = "figures/basalt.model.jpg"
fname_fig.basalt2d = "figures/basalt2d.jpg"
fname_fig.hanford2d = "figures/hanford2d.jpg"
fname_fig.basalt2d.model = "figures/basalt2d_model.jpg"
fname_fig.hanford2d.model = "figures/hanford2d_model.jpg"
fname_fig.ringold_a_2d = "figures/ringold_a_2d.jpg"
fname_fig.ringold_a_2d.model = "figures/ringold_a_2d_model.jpg"
fname_fig.ringold_e_2d = "figures/ringold_e_2d.jpg"
fname_fig.ringold_e_2d.model = "figures/ringold_e_2d_model.jpg"
fname_fig.ringold_lm_2d = "figures/ringold_lm_2d.jpg"
fname_fig.ringold_lm_2d.model = "figures/ringold_lm_2d_model.jpg"
fname_fig.cold_creek_2d = "figures/cold_creek_2d.jpg"
fname_fig.cold_creek_2d.model = "figures/cold_creek_2d_model.jpg"
fname_fig.taylor_flats_2d = "figures/taylor_flats_2d.jpg"
fname_fig.taylor_flats_2d.model = "figures/taylor_flats_2d_model.jpg"
fname_fig.river_bath_2d = "figures/river_bath_2d.jpg"
fname_fig.river_bath_2d.model = "figures/river_bath_2d_model.jpg"
...
image2D(z= cells_hanford, x= unit_x, y= unit_y, shade=0.2, rasterImage = F, NAcol = "white",
        main = c("DEM_500m"), asp = 1)
dev.off()
...
image2D(z= cells_taylor_flats, x= unit_x, y= unit_y, shade=0.2, rasterImage = F, NAcol = "white",
        main = c("taylor_flats_500m"), asp = 1)
dev.off()
...
image2D(z= cells_river_bath, x= unit_x, y= unit_y, shade=0.2, rasterImage = F, NAcol = "white",
        main = c("river_bath_500m"), asp = 1)
dev.off()

## plot mapped hanford layer
# jpeg(fname_fig.hanford.model, width=10, height=10,units='in',res=300,quality=100)
# par(mar=c(3, 3.2, 2.5, 0))
# filled.contour(unit_x, unit_y, cells_hanford,
...
#                },
#                
#                plot.title = title(main = c("DEM_1000_m_grid"))
# )
# dev.off()
...
# 
# 
# ##plot original basalt layer
# jpeg(fname_fig.basalt, width=10, height=10,units='in',res=300,quality=100)
# 
# par(mar=c(3, 3.2, 2.5, 0))
# filled.contour(basalt_data_model$x, basalt_data_model$y, basalt_data_model$z,
#                xlim=c(west_x,east_x),
#                ylim=c(south_y,north_y),
#                
#                zlim=c(-100,500),        
...
#                },
#                
#                plot.title = title(main = c("Basalt_original_30_m_grid"))
# )
# 
# dev.off()
# 
...
# nbcol = 100
# color = rev(rainbow(nbcol, start = 0/6, end = 4/6))
# zcol  = cut(basalt_data_model$z, nbcol)
# persp3d(basalt_data_model$x, basalt_data_model$y, basalt_data_model$z, col = color[zcol], aspect = c(1,1,0.2))
# 
# 
# ## plot mapped basalt layer
# jpeg(fname_fig.basalt.model, width=10, height=10,units='in',res=300,quality=100)
# par(mar=c(3,3.2,2.5,0))
# filled.contour(unit_x, unit_y, cells_basalt,
#                xlim=c(west_x,east_x),
#                ylim=c(south_y,north_y),
#                
#                zlim=c(-100,500),       
...
#                },
#                
#                plot.title = title(main = c("Basalt_mapped_1000_m_grid"))
# )
# 
# dev.off()
# 
...
# color = rev(rainbow(nbcol, start = 0/6, end = 4/6))
# zcol  = cut(cells_basalt, nbcol)
# persp3d(unit_x, unit_y, cells_basalt, col = color[zcol], aspect = c(1,1,0.2))
# 
# 
# }
