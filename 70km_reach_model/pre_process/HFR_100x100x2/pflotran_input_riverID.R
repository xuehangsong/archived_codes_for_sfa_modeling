...
fname_material.h5 = c("HFR_material_riverID_100m.h5")
# fname_H.BC.h5 = c("300A_H_BC.h5")
fname_H.initial.h5 = c("HFR_H_Initial.h5")
fname_model_inputs.r = "results/model_inputs_100m.r"
#-----------------OUTPUT--------------------------#
fname_pflotran.in = "Inputs/riverID/pflotran_riverID_100m.in"
