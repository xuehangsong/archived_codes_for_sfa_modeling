...
fname_fig.basalt2d.model = "figures/basalt2d_model_100x100x2m.jpg"
fname_fig.hanford2d.model = "figures/hanford2d_model_100x100x2m.jpg"
fname_fig.ringold_a_2d = "figures/ringold_a_2d.jpg"
fname_fig.ringold_a_2d.model = "figures/ringold_a_2d_model_100x100x2m.jpg"
fname_fig.ringold_e_2d = "figures/ringold_e_2d.jpg"
fname_fig.ringold_e_2d.model = "figures/ringold_e_2d_model_100x100x2m.jpg"
fname_fig.ringold_lm_2d = "figures/ringold_lm_2d.jpg"
fname_fig.ringold_lm_2d.model = "figures/ringold_lm_2d_model_100x100x2m.jpg"
fname_fig.cold_creek_2d = "figures/cold_creek_2d.jpg"
fname_fig.cold_creek_2d.model = "figures/cold_creek_2d_model_100x100x2m.jpg"
fname_fig.taylor_flats_2d = "figures/taylor_flats_2d.jpg"
fname_fig.taylor_flats_2d.model = "figures/taylor_flats_2d_model_100x100x2m.jpg"
fname_fig.river_bath_2d = "figures/river_bath_2d.jpg"
fname_fig.river_bath_2d.model = "figures/river_bath_2d_model_100x100x2m.jpg"
fname_geoFramework.r = "results/HFR_model_100x100x2_6h_bc/geoframework.r"
fname_ascii.r = "results/ascii.r"
fname_model_inputs.r = "results/HFR_model_100x100x2_6h_bc/model_inputs.r"
##---------------------FUNCTIONS---------------------------------##
...
jpeg(fname_fig.river_bath_2d, width=8,height=8,units='in',res=600,quality=100)
image2D(river_bath_data_model, shade=0.2, rasterImage = F, NAcol = "white", clab = "Elevation (m)", xlab = "Easting", 
        ylab = "Northing", xlim = c(551600, 611600), ylim = c(104500, 164500),
        asp = 1)
