...
fname.river_datum = paste(fname.DatumH.in, slice.list, ".txt", sep = "")
fname.river_gradient = paste(fname.Gradient.in, slice.list, ".txt", sep = "")
...
cat("\n")
cat(paste("  FILENAME", fname_H.initial.h5.in))
cat("\n")
...
cat("\n")
cat("  PERIODIC TIME 5 day between 4 y and 9 y")
cat("\n")
...
cat(paste("#  PERIODIC TIME"), output.ts, "h")
cat("\n")
cat("  PERIODIC TIME 6 h between 4 y and 9 y")
cat("\n")
cat('  /')
cat("\n")
cat("\n")
...
for (iriver in river_region) {
  ...
  cat('\n')
  cat(paste('  FILE ', fname_material.h5.in))
  cat('\n')
  cat('END')
  cat("\n")
  cat("\n")
...
cat("STRATA")
cat("\n")
cat(paste("  MATERIAL", fname_material.h5.in))
cat("\n")
cat("END")
cat("\n")
cat("\n")
