...
for (icolumn in 1:7)
{
    temp.data = as.matrix(read.csv(paste("results/",case.name,"_c",icolumn,"_Temperature [C].txt",sep=""),header=F))
    vx.data  = as.matrix(read.csv(paste("results/",case.name,"_c",icolumn,"_Liquid X-Velocity [m_per_h].txt",sep=""),header=F))/porosity*24
    vy.data  = as.matrix(read.csv(paste("results/",case.name,"_c",icolumn,"_Liquid Y-Velocity [m_per_h].txt",sep=""),header=F))/porosity*24
    vz.data  = as.matrix(read.csv(paste("results/",case.name,"_c",icolumn,"_Liquid Z-Velocity [m_per_h].txt",sep=""),header=F))/porosity*24
    ...
    temp.depth = as.numeric(unlist(read.csv(
        paste("results/",case.name,"_c1_depth.txt",sep=""),header=F)))
    ...
    jpeg(paste("figures/",case.name,"_",icolumn,"_temperature.jpg",sep=''),width=10,height=6,units='in',res=300,quality=100)
    ...
    jpeg(paste("figures/",case.name,"_",icolumn,"_vx.jpg",sep=''),width=10,height=6,units='in',res=300,quality=100)
    ...
    jpeg(paste("figures/",case.name,"_",icolumn,"_vy.jpg",sep=''),width=10,height=6,units='in',res=300,quality=100)
    ...
    jpeg(paste("figures/",case.name,"_",icolumn,"_vz.jpg",sep=''),width=10,height=6,units='in',res=300,quality=100)
