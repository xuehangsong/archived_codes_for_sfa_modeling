...
write.table(DatumH_River,file=paste('ert_model/DatumH_River_ERT.txt',sep=""),col.names=FALSE,row.names=FALSE)
write.table(Gradients_River,file=paste("ert_model/Gradients_River_ERT.txt",sep=''),col.names=FALSE,row.names=FALSE)
