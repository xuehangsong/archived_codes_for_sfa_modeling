...
alluvium.p = as.list(c(-0.1118135,0.5,5,10,90+9))
...
save(list=ls(),file="results/perm.data.all.1.r")
save(list=c("hanford.perm","alluvium.perm"),file="results/perm.data.1.r")


H5close()        
h5file = "ert_model/ERT_alluvium.h5"
...
H5close()        
h5file = "ert_model/ERT_hanford.h5"
