...
hanford.p = as.list(c(8.742916,1,20,10,90-3))
...
save(list=ls(),file="results/perm.data.all.2_1.r")
save(list=c("hanford.perm","alluvium.perm"),file="results/perm.data.2_1.r")


H5close()        
h5file = "ert_model/ERT_alluvium_2_1.h5"
...
H5close()        
h5file = "ert_model/ERT_hanford_2_1.h5"
