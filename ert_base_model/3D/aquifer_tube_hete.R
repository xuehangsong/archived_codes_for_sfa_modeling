...
save(list=ls(),file="results/perm_data_all.r")
save(list=c("hanford.perm","alluvium.perm"),file="results/perm_data.r")


H5close()        
h5file = "ert_model/aquifer_tube_alluvium.h5"
...
H5close()        
h5file = "ert_model/aquifer_tube_hanford.h5"
