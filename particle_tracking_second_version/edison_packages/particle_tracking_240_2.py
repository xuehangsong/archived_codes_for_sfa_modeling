...
material_file = "./flow_2008_3/BC_2008_2015/bigplume_4mx4mxhalfRes_material_mapped_newRingold_subRiver_17tracer.h5"
###pt_fname = "./results/path.pickle"
times = np.arange((8784+240*25),70000,1)
release_times = np.r_[(8784+240*25):70000:2400000]
pt_fname_template = "./results/path.pickle_25"
