...
end.time = as.POSIXct("2013-12-31 23:00:00",format="%Y-%m-%d %H:%M:%S",tz="GMT")
...
##tracking_start =  as.POSIXct("2013-06-04 00:00:00",format="%Y-%m-%d %H:%M:%S",tz="GMT")
## tracking_start =  as.POSIXct("2013-05-01 00:00:00",format="%Y-%m-%d %H:%M:%S",tz="GMT") ##46728
## tracking_start =  as.POSIXct("2013-06-03 00:00:00",format="%Y-%m-%d %H:%M:%S",tz="GMT") ##47520
tracking_start =  as.POSIXct("2013-10-09 00:00:00",format="%Y-%m-%d %H:%M:%S",tz="GMT") ##47520

nbar = 72
tracking.end = (250)*3600
...
for (itime in length(time.bar))
    {
        fname = paste("figures/2013_short_2/wl",itime-1,".jpg",sep="")        
        ...
        axis.POSIXct(1,at=seq(as.Date("2008-01-01",tz="GMT"),
                              to=as.Date("2016-01-01",tz="GMT"),by="month"),
