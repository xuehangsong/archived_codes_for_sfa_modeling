...
wells = c("1-10A","2-1","2-2","2-32","1-21A","4-9")
...
for (iwell in wells)
{
    tracer[["Tracer_river_n"]][[iwell]] = tracer[["Tracer_river_318"]][[iwell]]+tracer[["Tracer_river_319"]][[iwell]]
    tracer[["Tracer_river_m"]][[iwell]] = tracer[["Tracer_river_320"]][[iwell]]+tracer[["Tracer_river_321"]][[iwell]]
    tracer[["Tracer_river_s"]][[iwell]] = tracer[["Tracer_river_322"]][[iwell]]+tracer[["Tracer_river_323"]][[iwell]]+
