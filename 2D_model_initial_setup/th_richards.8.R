...
case.name="th_richards_compare.8"
...
mtext(side = 2,at=0.5,text='qlx (m/h)',col='black',line=4,cex=1.8)
...
mtext(side = 4,at=0,text='qlz (m/h)',col='black',line=4,cex=1.8)
...
load(paste(case.name,"/statistics/density.ensemble.r",sep=''))
par(mar=c(5,8,4,8),mgp=c(4,1.5,0),new=T,xpd=TRUE)
plot(interp.time,spc.value[["S10"]],
     col=NA,
     xlim=time.range,
...
lines(interp.time[compare.time],density.ensemble[2,iobs,compare.time],col='black',lty=1,lwd=5)
lines(interp.time[compare.time],density.ensemble[1,iobs,compare.time],col='red',lty=1,lwd=5)
lines(interp.time[compare.time],density.ensemble[3,iobs,compare.time],col='green',lty=3,lwd=5)
lines(interp.time[compare.time][1:140],density.ensemble[4,iobs,compare.time][1:140],col='gold',lty=3,lwd=5)



axis(side = 4,at=c(997,998,999,1000),col.axis='black',col='black',line=0.5,las=2,cex.axis=1.8)
mtext(side = 4,at=999,text='Liquid density (kg/m^3)',col='black',line=6,cex=1.8)





load(paste(case.name,"/statistics/temperature.ensemble.r",sep=''))
...
lines(interp.time[compare.time],temperature.ensemble[2,iobs,compare.time],col='black',lty=1,lwd=5)
lines(interp.time[compare.time],temperature.ensemble[1,iobs,compare.time],col='red',lty=1,lwd=5)
lines(interp.time[compare.time],temperature.ensemble[3,iobs,compare.time],col='green',lty=3,lwd=5)
lines(interp.time[compare.time],temperature.ensemble[4,iobs,compare.time],col='gold',lty=3,lwd=5)



axis(side = 2,at=c(6,12,18,24),col.axis='black',col='black',line=0.5,las=2,cex.axis=1.8)
mtext(side = 2,at=12,text='Temperature (C)',col='black',line=5,cex=1.8)
