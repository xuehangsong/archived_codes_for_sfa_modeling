...
lines(interp.time[compare.time],simu.ensemble[10,],col='red',lwd=3)
lines(interp.time[compare.time],simu.ensemble[13,],col='blue',lwd=3)
...
rect(interp.time[1+24*4],0,interp.time[24*11],0.6)
...
title("Histogram of S10 Simulation",line = 0)
dev.off()
