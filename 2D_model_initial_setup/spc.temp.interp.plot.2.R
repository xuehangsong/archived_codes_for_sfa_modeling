...
i=1
start.time = as.POSIXct("2016-01-29 00:00:00",tz="GMT",format="%Y-%m-%d %H:%M:%S")
end.time = as.POSIXct("2016-01-31 00:00:00",tz="GMT",format="%Y-%m-%d %H:%M:%S")

time.ticks = seq(start.time,end.time,3600*1)
time.range = range(start.time,end.time)


jpeg(paste("figures/spc.temp.slice2.",i,".jpg",sep=''),width=14,height=8.4,units='in',res=200,quality=100)
