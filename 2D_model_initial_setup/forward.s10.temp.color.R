...
jpeg(paste("figures/",case.name,".s10.1.temp.forward.jpg",sep=''),width=14,height=8.4,units='in',res=200,quality=100)
...
## for (ireaz in 1:10)
## {
##    lines(interp.time[compare.time],simu.ensemble[ireaz,compare.time],col='orangered',lwd=5)
## }
lines(interp.time[compare.time],simu.ensemble[7,compare.time],col='green',lwd=5)
