...
jpeg(paste("figures/mud.depth.2.s10.forward.jpg",sep=''),width=14,height=8.4,units='in',res=200,quality=100)
par(mar=c(5,5,4,5))
...
lines(interp.time[compare.time],simu.ensemble[1,],col='red',lwd=2)
lines(interp.time[compare.time],simu.ensemble[2,],col='orange',lwd=2)
lines(interp.time[compare.time],simu.ensemble[3,],col='black',lwd=2)
