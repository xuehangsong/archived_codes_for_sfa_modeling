...
compare.time = c(seq(97,172),seq(178,189),seq(202,240))
##compare.time = c(seq(173,177),seq(190,201),seq(241,265))
compare.time = c(seq(97,265))
...
save(list=ls(),file="results/s10.colored.3.r")
