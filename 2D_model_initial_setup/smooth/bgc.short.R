...
save(h5.data,file="results/h5.short.multi")
H5close()
...
for (itime in obs.time){
    ...
    jpeg.name = paste("figures/short.",formatC((itime-1),width = 3,flag = "0"),
...
#                   zlim = c(105,107),
                   ...
                   ylab = "Elevation (m)",
                   main = paste("Hydraulic head : t =",itime-1,"hour"),
                   asp = 1.0,
                   plot.axes = {
                       axis(1,cex.axis = 1.)
                       axis(2,cex.axis = 1.)
                       ...
                       for (i in x.vadose)
                           {
                               z.vadose[i] = min(z.index[x.index==i])
                               j=j+1
                           }
                       ...
                       lines(c(current.east.interface,400),rep(current.east.level,2),col = "blue",lwd = 0.8)
                       points(400,current.west.level,col = "black",pch = 16)
                       text(385,current.east.level+2,
                            paste("dh =",
    ...
    tracer = simu.results*30.026*1000
    tracer[elevation.field==0]=-10
    
    jpeg.name = paste("figures/short.",formatC((itime-1),width = 3,flag = "0"),"_CH2O",".jpg",sep = "")
    jpeg(jpeg.name,width = 12,height = 2.58,units = "in",res = 300, quality = 100)
    par(xpd=TRUE,mgp=c(2.,0.6,0),mar=c(4.1,4.1,2.1,2.1))
    filled.contour(x.new,z.new,tracer,
                   ...
                   main = bquote("CH"[2]*"O : t =" ~.(itime-1) ~ "hour" ),
                   asp = 1.0,
                   plot.axes = {
                       axis(1,cex.axis = 1.)
                       axis(2,cex.axis = 1.)
    ...
    jpeg.name = paste("figures/short.",formatC((itime-1),width = 3,flag = "0"),"_H+",".jpg",sep = "")
    jpeg(jpeg.name,width = 12,height = 2.58,units = "in",res = 300, quality = 100)
    par(xpd=TRUE,mgp=c(2.,0.6,0),mar=c(4.1,4.1,2.1,2.1))
    filled.contour(x.new,z.new,tracer,
                   ylim = c(90,110),
    ...
    tracer = simu.results*61.017*1000
    tracer[elevation.field==0]=-10
    
    jpeg.name = paste("figures/short.",formatC((itime-1),width = 3,flag = "0"),"_HCO3-",".jpg",sep = "")
    jpeg(jpeg.name,width = 12,height = 2.58,units = "in",res = 300, quality = 100)
    par(xpd=TRUE,mgp=c(2.,0.6,0),mar=c(4.1,4.1,2.1,2.1))
    filled.contour(x.new,z.new,tracer,
                   ylim = c(90,110),
                   ...
                   main = bquote("HCO"[3]*"- : t =" ~.(itime-1) ~ "hour" ),
                   asp = 1.0,
                   plot.axes = {
                       axis(1,cex.axis = 1.)
                       axis(2,cex.axis = 1.)
    ...
    jpeg.name = paste("figures/short.",formatC((itime-1),width = 3,flag = "0"),"_N2",".jpg",sep = "")
    jpeg(jpeg.name,width = 12,height = 2.58,units = "in",res = 300, quality = 100)
    par(xpd=TRUE,mgp=c(2.,0.6,0),mar=c(4.1,4.1,2.1,2.1))
    filled.contour(x.new,z.new,tracer,
                   ylim = c(90,110),
                   ...
                   main = bquote("N"[2]*"concentration : t =" ~.(itime-1) ~ "hour" ),
                   asp = 1.0,
                   plot.axes = {
                       axis(1,cex.axis = 1.)
                       axis(2,cex.axis = 1.)
    ...
    jpeg.name = paste("figures/short.",formatC((itime-1),width = 3,flag = "0"),"_NO3-",".jpg",sep = "")
    jpeg(jpeg.name,width = 12,height = 2.58,units = "in",res = 300, quality = 100)
    par(xpd=TRUE,mgp=c(2.,0.6,0),mar=c(4.1,4.1,2.1,2.1))
    filled.contour(x.new,z.new,tracer,
                   ylim = c(90,110),
                   ...
                   main = bquote("NO"[3]*"- : t =" ~.(itime-1) ~ "hour" ),
                   asp = 1.0,
                   plot.axes = {
                       axis(1,cex.axis = 1.)
                       axis(2,cex.axis = 1.)
    ...
    jpeg.name = paste("figures/short.",formatC((itime-1),width = 3,flag = "0"),"_O2",".jpg",sep = "")
    jpeg(jpeg.name,width = 12,height = 2.58,units = "in",res = 300, quality = 100)
    par(xpd=TRUE,mgp=c(2.,0.6,0),mar=c(4.1,4.1,2.1,2.1))
    filled.contour(x.new,z.new,tracer,
                   ylim = c(90,110),
                   ...
                   main = bquote("O"[2]*"concentration : t =" ~.(itime-1) ~ "hour" ),
                   asp = 1.0,
                   plot.axes = {
                       axis(1,cex.axis = 1.)
                       axis(2,cex.axis = 1.)
    ...
    jpeg.name = paste("figures/short.",formatC((itime-1),width = 3,flag = "0"),"_CI",".jpg",sep = "")
    jpeg(jpeg.name,width = 12,height = 2.58,units = "in",res = 300, quality = 100)
    par(xpd=TRUE,mgp=c(2.,0.6,0),mar=c(4.1,4.1,2.1,2.1))
    filled.contour(x.new,z.new,tracer,
                   ylim = c(90,110),
