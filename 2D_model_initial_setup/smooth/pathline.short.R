...
for (i.batch in 1:n.batch)
{
    ...
    jpeg(paste("figures/short.pathline_",i.batch,".jpg",sep=''),
    ...
    write.table(break.time,file=paste("results/short.break.time",i.batch,".dat",sep=''),col.names=FALSE,row.names=FALSE)
}
