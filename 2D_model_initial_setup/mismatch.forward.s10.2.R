...
jpeg(paste("figures/s10.2.forward.jpg",sep=''),width=14,height=8.4,units='in',res=200,quality=100)
par(mar=c(5,5,4,5))
...
lines(interp.time[compare.time],simu.ensemble[1,],col='red')
...
#rect(interp.time[24*17+1],0,interp.time[888],0.6)
