...
compare.time = seq(1+24*5,408-24*2)
...
{
    obs.value = (spc.temp.value[["S40"]]-spc.temp.value[["NRG"]])/(spc.temp.value[["2-3"]]-spc.temp.value[["NRG"]])
...
save(list=ls(),file="results/s40.temp.r")
