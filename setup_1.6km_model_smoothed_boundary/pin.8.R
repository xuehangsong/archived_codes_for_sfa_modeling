...
slice.y = coord.data[slice.list,2]
names(slice.y) = coord.data[,3]

fname = "bigplume_4mx4mxhalfRes_material_mapped.h5"
fname = "Plume_400x400x20_2mRes_material.h5"
fname = "bigplume_4mx4mxhalfRes_material_mapped_newRingold.h5"
...
face.ids[which(diff.material.ids==-9,arr.ind=TRUE)] = 2
...
face.ids[which(diff.material.ids==-9,arr.ind=TRUE)] = 4
...
face.ids[which(diff.material.ids==-9,arr.ind=TRUE)] = 6
...
reserve.face.cell = face.cell.ids.final 
...
fname = "New_bigplume_4mx4mxhalfRes_material_mapped_newRingold.h5"
...
slice.y = c(958.98092,720.62172,483.84195,400,250.95959,12.88545,0,-224.89861,-463.18944,-698.72383,-936.69066)
slice.list = c("318","319","320","north","321","322","south","323","324","325","326")
slice.list = c("318","319","320_1","320_2","321","322_1","322_2","323","324","325","326")
slice.list = paste("Region_River_",slice.list,sep="")
...
for (islice in slice.list[nslice:1])
{
    ...
    {
    h5createGroup(fname,paste("Regions/",islice,sep=''))
    h5write(face.cell,fname,paste("Regions/",islice,"/Cell Ids",sep=''),level=0)
    h5write(face.ids,fname,paste("Regions/",islice,"/Face Ids",sep=''),level=0)
    
    }
}
H5close()

write.table(slice.y,"slice.txt")
