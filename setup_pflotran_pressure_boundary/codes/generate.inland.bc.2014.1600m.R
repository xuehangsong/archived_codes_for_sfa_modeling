...
output_folder = "3dmodel/"
initial.h5 = "inland_ic_2014_1600m.h5"
BC.h5 = "inland_bc_2014_1600m.h5"
...
## time information
start.time = as.POSIXct("2014-01-01 01:00:00",tz="GMT",format="%Y-%m-%d %H:%M:%S")
end.time =  as.POSIXct("2014-02-01 00:00:00",tz="GMT",format="%Y-%m-%d %H:%M:%S")
...
save(list=ls(),file="results/inland.bc.2014.1600m.r")
