...
paths = c('Tracer_Mar2011_UK3_800to900h_Iter9/')
prior_path = 'Tracer_Mar2011_UK3_700to800h_Iter8/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_800to900h_Err20_Iter9.txt',sep=''))
new_iter = 10
