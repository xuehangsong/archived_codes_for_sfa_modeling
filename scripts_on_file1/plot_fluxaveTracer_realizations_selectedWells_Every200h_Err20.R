...
paths = c('Tracer_Mar2011_UK3_KrigeFields_Inj5','Tracer_Mar2011_UK3_Inj5_0to200h_Err20_Iter1','Tracer_Mar2011_UK3_Inj5_200to400h_Err20_Iter2','Tracer_Mar2011_UK3_Inj5_400to600h_Err20_Iter3')
...
plot_title = c('Prior: ','0 to 200 h: ','200 to 400 h: ','400 to 600 h: ')
output_name = 'EnKF_Fitting_Every200h_Err20_'
...
#plot
jpeg(paste(main_path,output_name,'_Realizations_',testvariable, plotfile, sep = ''), width = pwidth, height = pheight,units="in",res=200,quality=100)
par(mfrow=c(plot_nrow,plot_ncol),mar=c(4,5,3,3))
