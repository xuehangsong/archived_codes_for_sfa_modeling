...
paths = c('Tracer_Mar2011_UK3_Iter10/')
prior_path = 'Tracer_Mar2011_UK3_Iter9/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_230to250h_Err20_Iter10.txt',sep=''))
new_iter = 11
