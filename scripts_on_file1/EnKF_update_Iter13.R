...
paths = c('Tracer_Mar2011_UK3_Iter12/')
prior_path = 'Tracer_Mar2011_UK3_Iter11/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_270to290h_Err20_Iter12.txt',sep=''))
new_iter = 13
