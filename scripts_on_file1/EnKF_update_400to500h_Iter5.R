...
paths = c('Tracer_Mar2011_UK3_300to400h_Iter4/')
prior_path = 'Tracer_Mar2011_UK3_200to300h_Iter3/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_300to400h_Err20_Iter4.txt',sep=''))
new_iter = 5
