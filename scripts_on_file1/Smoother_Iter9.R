...
paths = c('Tracer_Mar2011_UK3_Inj5_350to400h_Err20_Iter8/')
prior_path = 'Tracer_Mar2011_UK3_Inj5_300to350h_Err20_Iter7'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_350to400h_Err20_Iter8.txt',sep=''))
new_iter = 9
