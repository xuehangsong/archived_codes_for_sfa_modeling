...
comp_paths = c('Geochem_Oct2011_Test0','Geochem_Oct2011_Test0_Hetero_InitU')
#comp_col = c('black','red','blue','darkgreen','mediumorchid')
comp_legends = c('Uniform_U','Hetero_U')
...
for(ifield in seq(1,nfields))
{
	...
	jpeg(paste(main_path,'/',plotfile_name,sub("^\\s+|\\s+$", "", testvariable),'_R',fields[ifield], plotfile, sep = ''), width = pwidth, height = pheight,units="in",res=150,quality=100)
