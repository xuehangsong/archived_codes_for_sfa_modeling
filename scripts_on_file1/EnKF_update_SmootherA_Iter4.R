...
paths = c('Tracer_Mar2011_UK3_SmootherA_Err10_Iter3/')
prior_path = 'Tracer_Mar2011_UK3_SmootherA_Err13_Iter2'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_0to1000h_Err10_Iter3.txt',sep=''))
new_iter = 4
