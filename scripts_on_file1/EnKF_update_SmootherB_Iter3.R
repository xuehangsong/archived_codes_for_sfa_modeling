...
paths = c('Tracer_Mar2011_UK3_SmootherB_Err15_Iter2/')
prior_path = 'Tracer_Mar2011_UK3_Smoother/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_0to1000h_Err15_Iter2.txt',sep=''))
new_iter = 3
