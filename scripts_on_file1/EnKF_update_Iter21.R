...
paths = c('Tracer_Mar2011_UK3_Iter20/')
prior_path = 'Tracer_Mar2011_UK3_Iter19/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_440to460h_Err20_Iter20.txt',sep=''))
new_iter = 21
