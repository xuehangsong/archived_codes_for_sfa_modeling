...
paths = c('Tracer_Mar2011_UK3_Iter19/')
prior_path = 'Tracer_Mar2011_UK3_Iter18/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_420to440h_Err20_Iter19.txt',sep=''))
new_iter = 20
