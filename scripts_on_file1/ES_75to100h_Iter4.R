...
paths = c('Tracer_Mar2011_Iter3/')
prior_path = 'Tracer_Mar2011_Iter2'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_50to75h_Err10_Iter3_set1.txt',sep=''))
new_iter = 4
