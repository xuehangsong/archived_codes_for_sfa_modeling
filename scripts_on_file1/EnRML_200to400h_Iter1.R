...
paths = c('Tracer_Mar2011_0to200h_Iter1/')
prior_path = 'Tracer_Mar2011_UK3_KrigeFields_Inj5'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_10to200h_Err10_Iter1_set1.txt',sep=''))
new_iter = 1
beta = 0.6     # reduced step size
