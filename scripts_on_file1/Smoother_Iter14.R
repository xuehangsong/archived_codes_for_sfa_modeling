...
paths = c('Tracer_Mar2011_UK3_Inj5_700to750h_Err20_Iter13/')
prior_path = 'Tracer_Mar2011_UK3_Inj5_600to700h_Err20_Iter12'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_700to750h_Err20_Iter13.txt',sep=''))
new_iter = 14
