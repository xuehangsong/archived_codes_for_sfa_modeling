...
paths = c('Tracer_Mar2011_UK3_Iter16/')
prior_path = 'Tracer_Mar2011_UK3_Iter15/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_350to360h_Err20_Iter16.txt',sep=''))
new_iter = 17
