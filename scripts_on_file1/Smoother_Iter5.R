...
paths = c('Tracer_Mar2011_UK3_Inj5_150to200h_Err20_Iter4/')
prior_path = 'Tracer_Mar2011_UK3_Inj5_100to150h_Err20_Iter3'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_150to200h_Err20_Iter4.txt',sep=''))
new_iter = 5
