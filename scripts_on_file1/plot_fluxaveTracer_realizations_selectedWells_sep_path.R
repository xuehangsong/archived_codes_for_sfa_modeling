...
paths = c('Tracer_Mar2011_UK3_Inj5_0to200h_Err30_Iter1','Tracer_Mar2011_UK3_Inj5_200to400h_Err30_Iter2','Tracer_Mar2011_UK3_Inj5_0to50h_Err20_Iter1','Tracer_Mar2011_UK3_Inj5_50to100h_Err20_Iter2','Tracer_Mar2011_UK3_Inj5_100to150h_Err20_Iter3','Tracer_Mar2011_UK3_Inj5_200to250h_Err20_Iter5','Tracer_Mar2011_UK3_Inj5_300to350h_Err20_Iter7')
#paths = c('Tracer_Mar2011_UK_EnKF_Batch_200to300h_Err10_Iter3','Tracer_Mar2011_UK_EnKF_Batch_0to500h_Err10_Iter2')
npath = length(paths)
fields =  seq(1,600) 
...
plot_title = c('Post 1st of 4 segs: ','Post 2nd of 4 segs: ', 'Post 1st of 16 segs: ', 'Post 2nd of 16 segs: ','Post 3rd of 16 segs: ','Post 5th of 16 segs: ','Post 7th of 16 segs: ')
output_name = ''
...
#wells_plot = c('2-07','2-26','2-13','2-18','3-25','3-28')
wells_plot = c('2-11','2-26','2-13')
...
for (ipath in 1:npath)
{
	...
	jpeg(paste(paths[ipath],output_name,'_Realizations_',testvariable, plotfile, sep = ''), width = pwidth, height = pheight,units="in",res=200,quality=100)
	par(mfrow=c(1,plot_ncol),mar=c(4,5,3,3))
 	for (ivar in 1:nwell)
	{
		...
		ymax = 1.0
		ymin = 0.0
		plot(fixedt,data0[,1], main=paste(plot_title[ipath],well_name,sep=''), xlab = b[1], ylab = y_label,xlim=c(0,1200), ylim = c(0, ymax), type = "l",lwd = linwd1, col = line_col,lty = 'solid',bty="n",cex.lab=1.7,cex.axis=1.7,cex.main=1.8) 
		for (irel in 2:nfields)
			lines(fixedt,data0[,irel],lwd=linwd1,col=line_col,lty='solid')
           
		points(true_t,trueBTC,col='black',type = 'b',lty='solid',lwd=linwd1,pch=1)
	}
	if(plot_legend)
		#plot(c(1,2),c(2,2),ylim=c(0,1),xlab="",ylab="",bty="n",axes = F)	
		legend("topright",c('Simulated','Observed'), lty=c('solid','solid'),col=c(line_col,'black'),lwd=c(linwd1,linwd1),pch=c(-1,1), cex=1.7, bty='n')
	dev.off() 	
}
