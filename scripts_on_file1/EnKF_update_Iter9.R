...
paths = c('Tracer_Mar2011_UK3_Iter8/')
prior_path = 'Tracer_Mar2011_UK3_Iter7/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_175to200h_Err20_Iter8.txt',sep=''))
new_iter = 9
