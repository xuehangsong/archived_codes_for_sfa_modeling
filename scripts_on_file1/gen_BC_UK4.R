...
input_folder = 'headdata4krige_Passive2010'
output_folder = 'BC_UK4_Passive2010'  # include corner wells and exclude 1-21a and 1-7
if (!file.exists(output_folder))    dir.create(file.path('./', output_folder))
