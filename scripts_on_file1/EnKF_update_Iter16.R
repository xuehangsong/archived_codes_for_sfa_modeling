...
paths = c('Tracer_Mar2011_UK3_Iter15/')
prior_path = 'Tracer_Mar2011_UK3_Iter14/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_320to340h_Err20_Iter15.txt',sep=''))
new_iter = 16
