...
paths = c('Tracer_Mar2011_UK3_Iter30/')
prior_path = 'Tracer_Mar2011_UK3_Iter29/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_730to750h_Err20_Iter30.txt',sep=''))
new_iter = 31
