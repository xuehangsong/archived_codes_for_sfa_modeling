...
paths = c('Tracer_Mar2011_UK3_Inj5_0to800h_Err30_Iter2','Tracer_Mar2011_UK3_Inj5_600to800h_Err30_Iter4','Tracer_Mar2011_UK3_Inj5_400to450h_Err20_Iter9')
...
plot_title = c('Post 2nd batch: ', 'Post 4 segments: ','Post 16 segments: ')
output_name = 'EnKF_Batch_Seg_Err30'
