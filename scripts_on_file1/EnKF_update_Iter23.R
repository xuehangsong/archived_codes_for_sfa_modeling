...
paths = c('Tracer_Mar2011_UK3_Iter22/')
prior_path = 'Tracer_Mar2011_UK3_Iter21/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_490to500h_Err20_Iter22.txt',sep=''))
new_iter = 23
