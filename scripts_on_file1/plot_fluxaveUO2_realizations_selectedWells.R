...
paths = c('Uranium_Mar2011_EnKF_Prior','Uranium_Mar2011_EnKF_Iter1','Uranium_Mar2011_EnKF_Iter3')
...
plot_title = c('Prior: ','Post 1st seg: ', 'Post 3rd seg: ')
output_name = 'EnKF_Uranium_Mar2011'
...
wells_plot = c('2-07','2-26','2-13','2-18','3-25','3-27')
