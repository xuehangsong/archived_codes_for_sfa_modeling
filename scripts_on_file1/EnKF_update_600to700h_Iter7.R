...
paths = c('Tracer_Mar2011_UK3_500to600h_Iter6/')
prior_path = 'Tracer_Mar2011_UK3_400to500h_Iter5/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_500to600h_Err20_Iter6.txt',sep=''))
new_iter = 7
