...
paths = c('Tracer_Mar2011_UK3_Iter25/')
prior_path = 'Tracer_Mar2011_UK3_Iter24/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_590to600h_Err20_Iter25.txt',sep=''))
new_iter = 26
