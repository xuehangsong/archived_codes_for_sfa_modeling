...
paths = c('Tracer_Mar2011_UK3_400to500h_Iter5/')
prior_path = 'Tracer_Mar2011_UK3_300to400h_Iter4/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_400to500h_Err20_Iter5.txt',sep=''))
new_iter = 6
