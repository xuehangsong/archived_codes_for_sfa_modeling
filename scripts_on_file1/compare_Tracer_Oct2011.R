...
#comp_paths = c('Geochem_Oct2011_Hetero_InitU_2_R270','Geochem_Oct2011_Hetero_InitU_2_R270_HighSD1','Geochem_Oct2011_Hetero_InitU_2_R270_HighSD2')
comp_paths = c('Tracer_Oct2011','Tracer_Oct2011_Iter3','Tracer_Oct2011_Iter3','Tracer_Oct2011_Iter3','Tracer_Oct2011_Iter3')
#comp_col = c('black','red','blue','darkgreen','mediumorchid','peru')
#comp_legends = c('base_SD','rate=2Base','rate=5Base')
comp_legends = c('Calibrated','R258_Iter3','R157_Iter3','R76_Iter3','R41_Iter3')
comp_col = c('red','blue','darkgreen','peru','mediumorchid')
#testvariable = ' UO2'
testvariable = 'Tracer1'
BC = 'Kriged'
npath = length(comp_paths)
fields = c(1,258,157,76,41)
...
pwidth = 26
pheight = 17
plotfile_name = 'Compare_PermRealizations_Iter3_2_'
