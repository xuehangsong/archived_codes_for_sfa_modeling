...
paths = c('Tracer_Mar2011_UK3_Iter23/')
prior_path = 'Tracer_Mar2011_UK3_Iter22/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_520to530h_Err20_Iter23.txt',sep=''))
new_iter = 24
