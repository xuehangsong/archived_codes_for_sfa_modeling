...
perm_par = read.table('Tracer_Mar2011_UK_EnKF_Batch_0to100h_Err10_Iter1/logK_Post_Samples_100to200h_Err10_Iter2.txt')
#file name for post par
post_par_file = paste('logK_Post_Samples_',min_time,'to',max_time_upper,'h_Err',err_cv,'_Iter3.txt',sep='')
