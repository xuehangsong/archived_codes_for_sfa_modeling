...
comp_paths = c('Tracer_Mar2011_UK3_KrigeFields_Inj2','Tracer_Mar2011_UK3_KrigeFields_Inj4')
plot_legend= T
comp_legends = c('Inj2','Inj4')
comp_col = c('darkgreen','darkred')
pwidth = 26
pheight = 17
testvariable = 'Tracer'
BC = 'Kriged'
...
linwd1 = 1.5
linwd2 = 1.5
plotfile_name = paste('Comp_Inj24_R',fields[1],sep='')
plotfile = '.jpg'
