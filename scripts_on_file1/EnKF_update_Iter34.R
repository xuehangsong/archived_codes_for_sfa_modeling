...
paths = c('Tracer_Mar2011_UK3_Iter33/')
prior_path = 'Tracer_Mar2011_UK3_Iter32/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_810to820h_Err20_Iter33.txt',sep=''))
new_iter = 34
