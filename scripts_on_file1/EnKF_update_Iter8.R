...
paths = c('Tracer_Mar2011_UK3_Iter7/')
prior_path = 'Tracer_Mar2011_UK3_Iter6/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_160to170h_Err20_Iter7.txt',sep=''))
new_iter = 8
