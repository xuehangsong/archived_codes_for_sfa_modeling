...
paths = c('Tracer_Mar2011_UK3_Iter29/')
prior_path = 'Tracer_Mar2011_UK3_Iter28/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_710to720h_Err20_Iter29.txt',sep=''))
new_iter = 30
