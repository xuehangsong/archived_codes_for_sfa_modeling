...
path_prev_iter_sample = 'Tracer_Mar2011_EnRML_0to800h_Iter1/' 
path_prev_iter_sim = 'Tracer_Mar2011_EnRML_0to800h_Iter2/'
...
perm_par_prev_iter = read.table(paste(path_prev_iter_sample,'logK_Post_Samples_EnRML_10to800h_Err10_Iter2_set1.txt',sep=''))
new_iter = 3
