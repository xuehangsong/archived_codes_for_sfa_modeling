...
paths = c('Tracer_Mar2011_UK3_700to800h_Iter8/')
prior_path = 'Tracer_Mar2011_UK3_600to700h_Iter7/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_700to800h_Err20_Iter8.txt',sep=''))
new_iter = 9
