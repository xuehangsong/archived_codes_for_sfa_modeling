...
paths = c('Tracer_Mar2011_UK3_Inj5_250to300h_Err20_Iter6/')
prior_path = 'Tracer_Mar2011_UK3_Inj5_200to250h_Err20_Iter5'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_250to300h_Err20_Iter6.txt',sep=''))
new_iter = 7
