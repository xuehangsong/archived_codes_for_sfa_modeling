...
paths = c('Tracer_Mar2011_UK3_Iter4/')
prior_path = 'Tracer_Mar2011_UK3_Iter3/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_90to100h_Err20_Iter4.txt',sep=''))
new_iter = 5
