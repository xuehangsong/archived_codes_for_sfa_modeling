...
paths = c('Tracer_Mar2011_Iter4/')
prior_path = 'Tracer_Mar2011_Iter3'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_75to100h_Err10_Iter4_set1.txt',sep=''))
new_iter = 5
