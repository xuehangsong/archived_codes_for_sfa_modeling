...
paths = c('Tracer_Mar2011_UK_EnKF_Batch_500to600h_Err10_Iter6/')
npath = length(paths)
fields = c(1:200)
par_idx = c(1:200)
...
perm_par = read.table('Tracer_Mar2011_UK_EnKF_Batch_400to500h_Err10_Iter5/logK_Post_Samples_500to600h_Err10_Iter6.txt')
#file name for post par
post_par_file = paste('logK_Post_Samples_',min_time,'to',max_time_upper,'h_Err',err_cv,'_Iter7.txt',sep='')
