...
paths = c('Tracer_Mar2011_UK3_100to200h_Iter2/')
prior_path = 'Tracer_Mar2011_UK3_0to100h_Iter1/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_115to200h_Err20_Iter2.txt',sep=''))
new_iter = 3
