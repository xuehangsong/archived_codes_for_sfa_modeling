...
paths = c('Tracer_Mar2011_UK3_Iter31/')
prior_path = 'Tracer_Mar2011_UK3_Iter30/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_760to770h_Err20_Iter31.txt',sep=''))
new_iter = 32
