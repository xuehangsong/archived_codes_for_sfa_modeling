...
comp_paths = c('Tracer_Mar2011_UK_Inv','Tracer_Mar2011_UK3_Iter25','Tracer_Mar2011_UK3_SmootherB_Err07_Iter4')
plot_legend= T
comp_legends = c('RML','EnKF_Iter25','Smoother')
comp_col = c('darkgreen','darkred','blue')
pwidth = 26
pheight = 17
testvariable = 'Tracer'
BC = 'Kriged'
npath = length(comp_paths)
fields = c(33059,273,184)
...
linwd1 = 1.5
linwd2 = 1.5
plotfile_name = 'Comp_Best_Fit_RML_EnKF_Smoother'
plotfile = '.jpg'
