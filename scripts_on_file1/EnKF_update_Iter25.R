...
paths = c('Tracer_Mar2011_UK3_Iter24/')
prior_path = 'Tracer_Mar2011_UK3_Iter23/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_570to580h_Err20_Iter24.txt',sep=''))
new_iter = 25
