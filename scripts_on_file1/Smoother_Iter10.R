...
prior_path = 'Tracer_Mar2011_UK3_Inj5_350to400h_Err20_Iter8'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_400to450h_Err20_Iter9.txt',sep=''))
new_iter = 10
