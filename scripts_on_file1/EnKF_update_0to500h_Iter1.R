...
paths = c('Tracer_Mar2011_UK_EnKF_Batch_0to500h_Err10_Iter1/')
npath = length(paths)
fields = c(1:200)
par_idx = c(1:200)
...
perm_par = read.table('Tracer_Mar2011_UK_KrigeFields/logK_Post_Samples_0to500h_Err10_Iter1.txt')
#file name for post par
post_par_file = paste('logK_Post_Samples_',min_time,'to',max_time_upper,'h_Err',err_cv,'_Iter2.txt',sep='')
