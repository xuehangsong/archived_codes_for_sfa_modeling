...
paths = c('Tracer_Mar2011_UK3_200to300h_Iter3/')
prior_path = 'Tracer_Mar2011_UK3_100to200h_Iter2/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_200to300h_Err20_Iter3.txt',sep=''))
new_iter = 4
