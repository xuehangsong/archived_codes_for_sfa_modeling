...
paths = c('Tracer_Mar2011_UK3_Iter18/')
prior_path = 'Tracer_Mar2011_UK3_Iter17/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_400to410h_Err20_Iter18.txt',sep=''))
new_iter = 19
