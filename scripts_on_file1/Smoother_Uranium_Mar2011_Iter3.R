...
paths = c('Uranium_Mar2011_Iter2/')
prior_path = 'Uranium_Mar2011_Iter1/'
new_iter = 3
npath = length(paths)
fields = c(1:200)
par_idx = c(1:200)
...
prior_par = read.table(paste(main_path,prior_path,'InitialU_Post_Samples_200to250h_Err10_Iter2.txt',sep=''))
...
wells = c('2-07','2-08','2-09','2-11','2-14','2-17','2-19','2-21','2-26','2-21','3-23','3-29','3-35')
