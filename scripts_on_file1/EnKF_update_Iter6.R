...
paths = c('Tracer_Mar2011_UK3_Iter5/')
prior_path = 'Tracer_Mar2011_UK3_Iter4/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_115to125h_Err20_Iter5.txt',sep=''))
new_iter = 6
