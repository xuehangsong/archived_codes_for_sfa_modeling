...
paths = c('Tracer_Mar2011_UK3_Iter11/')
prior_path = 'Tracer_Mar2011_UK3_Iter10/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_260to270h_Err20_Iter11.txt',sep=''))
new_iter = 12
