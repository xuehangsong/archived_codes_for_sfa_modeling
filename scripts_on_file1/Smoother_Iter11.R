...
paths = c('Tracer_Mar2011_UK3_Inj5_450to500h_Err20_Iter10/')
prior_path = 'Tracer_Mar2011_UK3_Inj5_400to450h_Err20_Iter9'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_450to500h_Err20_Iter10.txt',sep=''))
new_iter = 11
