...
paths = c('Tracer_Mar2011_UK3_Iter28/')
prior_path = 'Tracer_Mar2011_UK3_Iter27/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_660to670h_Err20_Iter28.txt',sep=''))
new_iter = 29
