...
paths = c('Tracer_Mar2011_UK3_Iter32/')
prior_path = 'Tracer_Mar2011_UK3_Iter31/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_780to790h_Err20_Iter32.txt',sep=''))
new_iter = 33
