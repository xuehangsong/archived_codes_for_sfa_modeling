...
paths = c('Tracer_Mar2011_Iter5/')
prior_path = 'Tracer_Mar2011_Iter4'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_100to125h_Err10_Iter5_set1.txt',sep=''))
new_iter = 6
