...
paths = c('Tracer_Mar2011_UK3_Iter13/')
prior_path = 'Tracer_Mar2011_UK3_Iter12/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_290to300h_Err20_Iter13.txt',sep=''))
new_iter = 14
