...
paths = c('Tracer_Mar2011_UK3_Iter26/')
prior_path = 'Tracer_Mar2011_UK3_Iter25/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_620to630h_Err20_Iter26.txt',sep=''))
new_iter = 27
