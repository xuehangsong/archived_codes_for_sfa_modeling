...
par = par[seq(1,30000,50),] #600 parameter sets were used
...
for (ipath in 1:npath)
{
	...
	write.table(new_par,file=paste(main_path,paths[ipath],'/input_par_Iter1.txt',sep=''),row.names=F,col.names=F)	
}
