...
paths = c('Tracer_Mar2011_UK3_Iter21/')
prior_path = 'Tracer_Mar2011_UK3_Iter20/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_470to480h_Err20_Iter21.txt',sep=''))
new_iter = 22
