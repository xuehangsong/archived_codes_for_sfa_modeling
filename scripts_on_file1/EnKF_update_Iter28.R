...
paths = c('Tracer_Mar2011_UK3_Iter27/')
prior_path = 'Tracer_Mar2011_UK3_Iter26/'
...
perm_par = read.table(paste(prior_path,'/','logK_Post_Samples_640to650h_Err20_Iter27.txt',sep=''))
new_iter = 28
