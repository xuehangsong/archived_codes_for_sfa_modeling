...
load(paste("highlight.data/",ireaz,"_","DOC_Rate [mol_m^3-sec]","_",ix,".r",sep=""))
a=value
load(paste("highlight.data/",ireaz,"_","CO2_Rate [mol_m^3-sec]","_",ix,".r",sep=""))
b=value
value = (a-b)[,-c(365,365+366,365*2+366,365*3+366)]
