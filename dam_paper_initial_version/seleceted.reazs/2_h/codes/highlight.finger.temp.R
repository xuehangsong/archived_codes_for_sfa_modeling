...
time.ticks = c(
    as.POSIXct("2012-01-01 12:01:01",tz="GMT",format="%Y-%m-%d %H:%M:%S"),
    as.POSIXct("2012-02-01 12:01:01",tz="GMT",format="%Y-%m-%d %H:%M:%S"),
    as.POSIXct("2012-03-01 12:01:01",tz="GMT",format="%Y-%m-%d %H:%M:%S"),
    as.POSIXct("2012-04-01 12:01:01",tz="GMT",format="%Y-%m-%d %H:%M:%S"),
    as.POSIXct("2012-05-01 12:01:01",tz="GMT",format="%Y-%m-%d %H:%M:%S"),
    as.POSIXct("2012-06-01 12:01:01",tz="GMT",format="%Y-%m-%d %H:%M:%S"),
    as.POSIXct("2012-07-01 12:01:01",tz="GMT",format="%Y-%m-%d %H:%M:%S"),
    as.POSIXct("2012-08-01 12:01:01",tz="GMT",format="%Y-%m-%d %H:%M:%S"),
    as.POSIXct("2012-09-01 12:01:01",tz="GMT",format="%Y-%m-%d %H:%M:%S"),
    as.POSIXct("2012-10-01 12:01:01",tz="GMT",format="%Y-%m-%d %H:%M:%S"),
    as.POSIXct("2012-11-01 12:01:01",tz="GMT",format="%Y-%m-%d %H:%M:%S"),
    as.POSIXct("2012-12-01 12:01:01",tz="GMT",format="%Y-%m-%d %H:%M:%S")
    )
...
filled.contour(files*3*3600+start.time,z,field,
               ...
               color = bluered,                   
               ylim = c(98.5,110),
               xlim = c(as.POSIXct("2012-03-01 12:01:01",tz="GMT",format="%Y-%m-%d %H:%M:%S"),
                        as.POSIXct("2012-08-01 12:01:01",tz="GMT",format="%Y-%m-%d %H:%M:%S")
                        ),
               zlim = c(0,25),
               xlab = "",
