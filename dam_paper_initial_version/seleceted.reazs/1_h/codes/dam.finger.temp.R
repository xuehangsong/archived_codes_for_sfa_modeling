...
##jpeg(paste("download.figure/",ireaz,"/","finger.",ivari,"_",ix,".jpg",sep=""),width=5.4,height=1.3,units="in",res=600,quality=100)
##par(mgp=c(2.,0.6,0),mar=c(2.5,3,1,1))

jpg.name = paste("download.figure/",ireaz,"/","finger.",ivari,"_",ix,".jpg",sep="")
