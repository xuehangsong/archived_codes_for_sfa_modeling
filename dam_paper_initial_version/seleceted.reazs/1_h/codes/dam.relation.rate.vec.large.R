...
jpg.name = paste("download.figure/",ireaz,"/rate.vec.jpg",sep = "")
...
box()
mtext(expression(paste("Mean velocity (log10, m/h)")),1,1.7)
###mtext(expression(paste("Carbon consumption (log10, mol/m"^2,")")),2,1.5)
