...
library(rhdf5)
nsim = 3000
material.file = "../../facies/facies.model.1/reference/T3_Slice_material.h5"
...
for (iperm in 1:nsim) {
    ...
    indicator[which(material.ids!=1)] = 0
    ...
    save(net.code,file=paste("results/hanford/code.",iperm,".r",sep=''))
    ## net.code.1 = net.code
    ## n.major.body = 10
    ## net.code.1[which(net.code>n.major.body)] = 0

    ## jpegfile=paste("./figures/hanford_geobody",iperm,"_1e_12_10",".jpg",sep="")
    ## jpeg(jpegfile,width=12,height=3.4,units='in',res=1200,,quality=100)
    ...
    ##       main=paste("Threshold = 7.4e-9m^2,","N Bodies = 10",": Realization=",iperm)
    ##       )
    ## dev.off()
