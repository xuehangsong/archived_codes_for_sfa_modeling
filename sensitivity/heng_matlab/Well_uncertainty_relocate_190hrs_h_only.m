...
% end
% well_82_st_c1_real(1:15,1:3,1:10) = 0;
% well_82_ss_c1_real(1:15,1:3,1:10) = 0;
% well_82_sm_c1_real(1:15,1:3,1:10) = 0;
% for i = 1:10
%     m = 0;
...
% fclose(fid3);
for i = 1:N
    fid1 = fopen(sprintf(['C:/Users/daih524/Desktop/2015_Spring/Data_for_Test_Case/BC_Data_From_Chen/4heng/well_data_with_sensitivity/well_sensitivity_h_ss_%d.txt'],5*(i-1)),'w+');
    fid2 = fopen(sprintf(['C:/Users/daih524/Desktop/2015_Spring/Data_for_Test_Case/BC_Data_From_Chen/4heng/well_data_with_sensitivity/well_sensitivity_h_sm_%d.txt'],5*(i-1)),'w+');
    fid3 = fopen(sprintf(['C:/Users/daih524/Desktop/2015_Spring/Data_for_Test_Case/BC_Data_From_Chen/4heng/well_data_with_sensitivity/well_sensitivity_h_st_%d.txt'],5*(i-1)),'w+');
    for j = 1:82
        fprintf(fid1,'%d %d %d\n', well_82_ss(j,:,i));
    end
    for j = 1:82
