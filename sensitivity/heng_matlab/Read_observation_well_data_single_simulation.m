...
%function [Time,wellnamegroup,Head_1,fluxavc1,fluxavc2] = Read_observation_well_data_single_simulation()
function [Time,wellnamegroup,fluxavc1,fluxavc2] = Read_observation_well_data_single_simulation()
randcpu = 160;
inputn = 100;
%realn = 1;
pho = 996.877;
g = 9.81;
%openfolder1 = sprintf(['C:/Users/daih524/Desktop/2015_Spring/'...
%                'Data_for_Test_Case/BC_Data_From_Chen/4heng/Uncertainty_output/BC_Base_MID_Base']);

openfolder1 = sprintf(['E:/PNNL_Research_Data/BC_Simulation_results/76_realization']);
%                'Data_for_Test_Case/BC_Data_From_Chen/4heng/Uncertainty_output/BC_Base_MID_Base']);E:\PNNL_Research_Data\Material_ID_Simulation_results\Results_Realization_76
