...
well_82_st(1:82,1:3,1:10) = 0;
well_82_sm(1:82,1:3,1:10) = 0;
well_82_ss(1:82,1:3,1:10) = 0;
...
% end
well_82_st_c1_real(1:13,1:3,1:20) = 0;
well_82_ss_c1_real(1:13,1:3,1:20) = 0;
well_82_sm_c1_real(1:13,1:3,1:20) = 0;
for i = 1:10
    m = 0;
...
% for i = 1:20
%     well_82_st_c1(1:82,3,i) = S_T_c1(wellindex(1:82),i+1);
%     well_82_sm_c1(1:82,3,i) = S_M_c1(wellindex(1:82),i+1);
%     well_82_ss_c1(1:82,3,i) = S_S_c1(wellindex(1:82),i+1);
% end
% for i = 1:40
%     well_82_st_c2(1:82,3,i) = S_T_c2(wellindex(1:82),i+1);
%     well_82_sm_c2(1:82,3,i) = S_M_c2(wellindex(1:82),i+1);
%     well_82_ss_c2(1:82,3,i) = S_S_c2(wellindex(1:82),i+1);
% end
% for i = 1:82
%     fprintf(fid1,'%d %d %d\n', well_82_st_100(i,:));
% end
...
% fclose(fid3);
for i = 0:9
    fid1 = fopen(sprintf(['C:/Users/daih524/Desktop/2015_Spring/Data_for_Test_Case/BC_Data_From_Chen/4heng/well_data_with_sensitivity/well_sensitivity_h_ss_%d.txt'],10+20*i),'w+');
    fid2 = fopen(sprintf(['C:/Users/daih524/Desktop/2015_Spring/Data_for_Test_Case/BC_Data_From_Chen/4heng/well_data_with_sensitivity/well_sensitivity_h_sm_%d.txt'],10+20*i),'w+');
    fid3 = fopen(sprintf(['C:/Users/daih524/Desktop/2015_Spring/Data_for_Test_Case/BC_Data_From_Chen/4heng/well_data_with_sensitivity/well_sensitivity_h_st_%d.txt'],10+20*i),'w+');
    for j = 1:82
        fprintf(fid1,'%d %d %d\n', well_82_ss(j,:,i+1));
    end
    for j = 1:82
...
% for i = 1:20
%     fid1 = fopen(sprintf(['C:/Users/daih524/Desktop/2015_Spring/Data_for_Test_Case/BC_Data_From_Chen/4heng/well_data_with_sensitivity/well_sensitivity_c1_ss_%d.txt'],20*i),'w+');
%     fid2 = fopen(sprintf(['C:/Users/daih524/Desktop/2015_Spring/Data_for_Test_Case/BC_Data_From_Chen/4heng/well_data_with_sensitivity/well_sensitivity_c1_sm_%d.txt'],20*i),'w+');
%     fid3 = fopen(sprintf(['C:/Users/daih524/Desktop/2015_Spring/Data_for_Test_Case/BC_Data_From_Chen/4heng/well_data_with_sensitivity/well_sensitivity_c1_st_%d.txt'],20*i),'w+');
%     for j = 1:11
%         fprintf(fid1,'%d %d %d\n', well_82_ss_c1(j,:,i));
%     end
%     for j = 13:82
...
for i = 0:9
    fid1 = fopen(sprintf(['C:/Users/daih524/Desktop/2015_Spring/Data_for_Test_Case/BC_Data_From_Chen/4heng/well_data_with_sensitivity/well_sensitivity_c1_ss_real_%d.txt'],20*i),'w+');
    fid2 = fopen(sprintf(['C:/Users/daih524/Desktop/2015_Spring/Data_for_Test_Case/BC_Data_From_Chen/4heng/well_data_with_sensitivity/well_sensitivity_c1_sm_real_%d.txt'],20*i),'w+');
    fid3 = fopen(sprintf(['C:/Users/daih524/Desktop/2015_Spring/Data_for_Test_Case/BC_Data_From_Chen/4heng/well_data_with_sensitivity/well_sensitivity_c1_st_real_%d.txt'],20*i),'w+');
    for j = 1:max(size(well_82_ss_c1_real(:,1,i+1)));
        if well_82_ss_c1_real(j,1,i+1)~= 0
            fprintf(fid1,'%d %d %d\n', well_82_ss_c1_real(j,:,i+1));
        end
    end
    for j = 1:max(size(well_82_sm_c1_real(:,1,i+1)));
        if well_82_sm_c1_real(j,1,i+1)~= 0
            fprintf(fid2,'%d %d %d\n', well_82_sm_c1_real(j,:,i+1));
        end
    end
    for j = 1:max(size(well_82_st_c1_real(:,1,i+1)));
        if well_82_st_c1_real(j,1,i+1)~= 0
            fprintf(fid3,'%d %d %d\n', well_82_st_c1_real(j,:,i+1));
        end
    end
    fclose(fid1);
    fclose(fid2);
