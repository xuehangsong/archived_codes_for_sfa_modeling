...
function [Time,Head_1,fluxavc1,wellname,wellnamegroup] = Read_observation_well_data_uncertainty_190_hrs_single_simulatio(openfolder1)
...
for i = 1:inputn
    ...
    for k = 1:randcpu
        openfolder = sprintf([openfolder1...
            '/pflotran1R%d-obs-%d.tec'],i+realn,k);
