...
jpeg(paste("figures/mass.gap.fill_extend.jpg",sep=''),width=16,height=5,units='in',res=200,quality=100)
...
jpeg(paste("figures/river.gradient.rquare_extend.jpeg",sep=''),width=16,height=5,units='in',res=200,quality=100)
...
save(gradient,file="results/river.gradient.r.2010_2015_extend.r")

save(level.combined,file="results/river.level.r.2010_2015_extend.r")

write.table(DatumH_River,file=paste('DatumH_River_2010_2015_extend.txt',sep=""),col.names=FALSE,row.names=FALSE)
write.table(Gradients_River,file=paste("Gradients_River_2010_2015_extend.txt",sep=''),col.names=FALSE,row.names=FALSE)
