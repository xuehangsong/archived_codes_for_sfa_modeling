...
jpeg(paste("figures/bpt.river.temp.gap.jpg",sep=''),width=16,height=5,units='in',res=200,quality=100)
...
jpeg(paste("figures/bpt.inland.temp.gap.jpg",sep=''),width=16,height=5,units='in',res=200,quality=100)
...
jpeg(paste("figures/bpt_temp.inland_river.jpg",sep=''),width=16,height=5,units='in',res=200,quality=100)
...
write.table(temp.river,file=paste('Temp_River_2012_2015.txt',sep=""),col.names=FALSE,row.names=FALSE)
write.table(temp.inland,file=paste('Temp_Inland_2012_2015.txt',sep=""),col.names=FALSE,row.names=FALSE)
