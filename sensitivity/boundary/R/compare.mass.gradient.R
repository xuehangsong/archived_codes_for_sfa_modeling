...
jpeg(paste("figures/mass.mutiple.slice.jpg",sep=''),width=15,height=4,units='in',res=200,quality=100)
...
jpeg(paste("figures/mass.mutiple.slice.scale.jpg",sep=''),width=15,height=4,units='in',res=200,quality=100)
...
jpeg(paste("figures/mean.gradient.jpeg",sep=''),width=10,height=4,units='in',res=200,quality=100)
