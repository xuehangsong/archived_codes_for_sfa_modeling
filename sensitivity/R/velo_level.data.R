##=== This file is used to collect all pressure data from velo
##=== Xuehang Song
...
obs.list =  c("1-10A","1-1","1-16A","1-57","2-2","2-3",
              "2-1","3-18","3-9","3-10","4-9","4-7","SWS-1")
...
save(list=c("obs.value","obs.time"),file = paste("results/","velo.level.r",sep=''))
