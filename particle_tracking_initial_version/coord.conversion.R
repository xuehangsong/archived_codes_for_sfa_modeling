...
proj.coord = read.csv("data/well_coordinates_all.csv")
row.names(proj.coord) = proj.coord[,1]
proj.coord = proj.coord[,c(4,3)]
...
write.table(model.coord,file = "data/model.coord.dat",col.names = FALSE)    
save(model.coord,file="data/model_well.r")
stop()
